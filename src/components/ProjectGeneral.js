...
export const ProjectGeneral = (props) => {

    let navigate = useNavigate();

    return (
        <div id="generalProjectDiv">
            <a className="paragraphProjectTitle" onClick={() => navigate('currentSelectedProject',{state:{project : props.project, creator : props.creator, currentUserEmail : props.currentUserEmail}})}>
